...
var_jv_pg_fr_people_to_find='[
    {"name": "Barack Obama", "image": "plugins_installed/jarvis-face-recognition/example/barack_obama.jpg"},
    {"name": "Hillary Clinton", "image": "plugins_installed/jarvis-face-recognition/example/hillary_clinton.jpg"}
